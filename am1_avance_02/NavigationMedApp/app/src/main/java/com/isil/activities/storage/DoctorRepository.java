...
public class DoctorRepository {
    ...
    public void mock() {
        ...
        DoctorEntity doctorEntity= new DoctorEntity(1,"Dr. Raul Gonzales","Cardiologia","Sede Miraflores",true);
        doctorEntity.setIcon(R.drawable.doc1);
        DoctorEntity doctorEntity1= new DoctorEntity(2,"Dra. Carla Doig","Traumatologia","Sede Jesus Maria",true);
        doctorEntity1.setIcon(R.drawable.doc2);
        DoctorEntity doctorEntity2= new DoctorEntity(3,"Dr. Carlos Garcia","Oftalmologia","Sede Miraflores",false);
        doctorEntity2.setIcon(R.drawable.doc3);
        DoctorEntity doctorEntity4= new DoctorEntity(4,"Dr. Ruben Razo","Endocrinologia","Sede La Molina",true);
        doctorEntity4.setIcon(R.drawable.doc4);
        DoctorEntity doctorEntity5= new DoctorEntity(5,"Dr. Fernando Wong","Cardiologia","Sede Jesus Maria",false);
        doctorEntity5.setIcon(R.drawable.doc5);
        DoctorEntity doctorEntity6= new DoctorEntity(6,"Dr. Roberto Cruz","Dermatologia","Sede La Molina",true);
        doctorEntity6.setIcon(R.drawable.doc6);
        DoctorEntity doctorEntity7= new DoctorEntity(7,"Dr. Enrique Peña","Traumatologia","Sede Jesus Maria",false);
        doctorEntity7.setIcon(R.drawable.doc7);
        DoctorEntity doctorEntity8= new DoctorEntity(8,"Dr. Jose Zegarra","Cardiologia","Sede La Molina",true);
        doctorEntity8.setIcon(R.drawable.doc8);
        DoctorEntity doctorEntity9= new DoctorEntity(9,"Dr. Eduardo Leon","Oftalmologia","Sede Los Olivos",false);
        doctorEntity9.setIcon(R.drawable.doc9);
        DoctorEntity doctorEntity10= new DoctorEntity(10,"Dr. Ricardo Lara","Dermatologia","Sede Los Olivos",true);
        doctorEntity10.setIcon(R.drawable.doc10);
        DoctorEntity doctorEntity11= new DoctorEntity(11,"Dra. Rita Gomez","Endocrinologia","Sede Miraflores",true);
        doctorEntity11.setIcon(R.drawable.doc11);
        DoctorEntity doctorEntity12= new DoctorEntity(12,"Dr. Jesus Fernandez","Traumatologia","Sede La Molina",false);
